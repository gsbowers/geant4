...
// ********************************************************************
//
/// \file eventgenerator/exgps/src/g4EventActionMessenger.cc
/// \brief Implementation of the g4EventActionMessenger class
//
...
g4EventActionMessenger::g4EventActionMessenger(
                                                                                                                g4EventAction* EvAct)
:fEventAction(EvAct)
{ 
...
void g4EventActionMessenger::SetNewValue(G4UIcommand * command,
                                                                                                                        G4String newValue)
{ 
  if(command == fDrawCmd)
