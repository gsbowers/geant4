...
// ********************************************************************
//
/// \file eventgenerator/exgps/src/g4AnalysisMessenger.cc
/// \brief Implementation of the g4AnalysisMessenger class
//
...
g4AnalysisMessenger::g4AnalysisMessenger(g4AnalysisManager* analysisManager)
  :fExGPSAnalysis(analysisManager)

{ 
  fExGPSAnalysisDir = new G4UIdirectory("/analysis/");
  fExGPSAnalysisDir->SetGuidance("g4 analysis control.");
