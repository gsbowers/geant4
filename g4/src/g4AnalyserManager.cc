...
// ********************************************************************
//
/// \file eventgenerator/exgps/src/g4AnalysisManager.cc
/// \brief Implementation of the g4AnalysisManager class
//
...
g4AnalysisManager* g4AnalysisManager::fInstance = 0;
...
fEnerHisto(0),fPosiXY(0),fPosiXZ(0),fPosiYZ(0),fAnglCTP(0),fAnglTP(0),fTuple(0)
{
  ...
  fAnalysisMessenger = new g4AnalysisMessenger(this);
...
g4AnalysisManager* g4AnalysisManager::GetInstance ()
{
  if (fInstance == 0) fInstance = new g4AnalysisManager();
  return fInstance;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void g4AnalysisManager::Dispose()
{
  if (fInstance != 0)
  {
    delete fInstance;
...
void g4AnalysisManager::Fill(G4String pname, G4double e, 
...
*/
void g4AnalysisManager::BeginOfRun() 
{ 
  fTree = 0;
  fPlotter = 0;
  fEnerHisto =0;
  ...
  {
    G4cout << "g4AnalysisManager::BeginOfRun: can't get AIDA." << G4endl; 
    return;
  }
  ...
  if(treeFactory) 
  {
    ...
    {
      G4cout << "g4AnalysisManager::BeginOfRun:"
...
*/
void g4AnalysisManager::EndOfRun() 
{
  if (fAnalysisFactory)
  {
